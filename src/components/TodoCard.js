...
export default function TodoCard({ note, handleDeleteTodo }) {
    ...
    return (
        <div className={classes.prop}>
            <Card elevation={2}>
                ...
                action={
                    <SimpleMenu note = {note} handleDelete={handleDeleteTodo} />
                  }
                  title={note.category}
                />
                <CardContent>
                <CardActionArea variant="outlined" color="primary" onClick={handleClickOpen}>
                  ...
                  <Typography variant="h6">15 Jul</Typography>
                  <br />
                  <Typography variant="h6">0% Complete</Typography>
