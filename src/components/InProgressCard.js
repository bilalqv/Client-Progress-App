...
import { IconButton, Typography, makeStyles, Avatar,withStyles } from '@material-ui/core';
...
export default function InProgressCard({ note, handleDeleteInProgress }) {
    ...
    return (
        <div className={classes.prop}>
            ...
            <Card elevation={2}>
                ...
                action={
                    <SimpleMenu note = {note} handleDelete={handleDeleteInProgress} />
                  }
                  title={note.category}
                />
                <CardContent>
                ...
                <Typography variant="h6">17 Jul</Typography>
                <br />
                <Typography variant="h6">{note.percentage}% Complete</Typography>
